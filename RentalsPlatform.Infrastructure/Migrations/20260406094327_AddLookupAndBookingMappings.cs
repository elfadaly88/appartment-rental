...
{
    /// <inheritdoc />
    public partial class AddLookupAndBookingMappings : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { 1, "مصر", "Egypt" });

            migrationBuilder.InsertData(
                table: "Governorates",
                columns: new[] { "Id", "CountryId", "NameAr", "NameEn" },
                values: new object[,]
                {
                    { 1, 1, "القاهرة", "Cairo" },
                    { 2, 1, "الجيزة", "Giza" },
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    ...
                    { 2, 1, "المعادي", "Maadi" },
                    { 3, 1, "التجمع الخامس", "New Cairo" },
                    { 4, 2, "الدقي", "Dokki" },
                    { 5, 2, "المهندسين", "Mohandessin" },
                    { 6, 2, "الشيخ زايد", "Sheikh Zayed" },
                    { 7, 2, "6 أكتوبر", "6th of October" },
                    { 8, 3, "سموحة", "Smouha" },
                    { 9, 3, "سيدي جابر", "Sidi Gaber" },
                    { 10, 3, "العجمي", "Agami" },
                    { 11, 3, "المنتزه", "Montaza" }
                });
